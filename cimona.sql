...
--
-- Host: localhost:3306
-- Tempo de geração: 09/09/2020 às 15:03
-- Versão do servidor: 5.7.31-0ubuntu0.18.04.1
-- Versão do PHP: 7.2.32-1+ubuntu18.04.1+deb.sury.org+1
...
--
-- Fazendo dump de dados para tabela `tb_admin.online`
--

INSERT INTO `tb_admin.online` (`id`, `ip`, `ultima_acao`, `token`) VALUES
(15, '127.0.0.1', '2020-09-09 15:01:47', '5f590653a715c');
...
(1, 'admin', 'admin', '5f4e482e03d99.png', 'Raimundo Nonato Sampaio', 2),
...
--
-- Fazendo dump de dados para tabela `tb_admin.visitas`
--
...
(15, '::1', '2017-06-27'),
(16, '::1', '2017-07-03'),
(17, '127.0.0.1', '2020-08-28'),
(18, '::1', '2020-09-09'),
(19, '::1', '2020-09-09'),
(20, '::1', '2020-09-09'),
(21, '::1', '2020-09-09'),
(22, '::1', '2020-09-09'),
(23, '127.0.0.1', '2020-09-09'),
(24, '127.0.0.1', '2020-09-09'),
(25, '127.0.0.1', '2020-09-09'),
(26, '127.0.0.1', '2020-09-09');
...
--
-- Fazendo dump de dados para tabela `tb_site.categorias`
--
...
--
-- Fazendo dump de dados para tabela `tb_site.config`
--
...
--
-- Fazendo dump de dados para tabela `tb_site.depoimentos`
--

INSERT INTO `tb_site.depoimentos` (`id`, `nome`, `depoimento`, `data`, `order_id`) VALUES
(8, 'Guilherme', 'Olá, funcionando', '19/09/2019', 8),
(9, 'João', 'Olá, funcionando', '19/09/2019', 11),
(10, 'Mario', 'Depoimento', '19/09/2019', 10),
(11, 'Outro', 'Ok', '19/08/2016', 9),
...
--
-- Fazendo dump de dados para tabela `tb_site.noticias`
--
...
--
-- Fazendo dump de dados para tabela `tb_site.servicos`
--
...
--
-- Fazendo dump de dados para tabela `tb_site.slides`
--
