...
<div class="box-content">
	...
	<form method="post" enctype="multipart/form-data">
			...
			if(isset($_POST['acao'])){
				...
				if($imagem['name'] != ''){
					...
					if(Painel::imagemValida($imagem)){
						...
						$arr = ['nome'=>$nome,'descricao'=>$descricao,'slide'=>$imagem,'id'=>$id,'nome_tabela'=>'tb_site.slides'];
						Painel::update($arr);
						$slide = Painel::select('tb_site.slides','id = ?',array($id));
		...
		<div class="form-group">
         ...
         <div class="form-group">
			<label>Resumo do slider:</label>
			<textarea name="descricao"><?php echo $slide['descricao']; ?></textarea>
		</div><!--form-group-->
